...
public class MarioProjekt {
    ...
    public static void main(String[] args) {
       pizzaArray marioPIzzaMenu = new pizzaArray("Mario's Pizza");
       ...
       marioPIzzaMenu.tilføjPizza(new Pizza("Silvia","tomatsauce, ost, pepperoni, rød peber, løg og oregano",61,7));
       ...
       UserInterface.userDialog(marioPIzzaMenu);
